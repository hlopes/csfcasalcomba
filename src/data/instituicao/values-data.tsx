  ...
  description: (
    <ul className="space-y-8">
      ...
      <li>
        ...
        ao nível do desenvolvimento de iniciativas adequadas à realidade social
        e ao nível da formação contínua dos seus diretores, gestores, e
        colaboradores. Somente desta forma, a instituição se poderá adaptar ao
      ...
      <li>
        ...
        religião, etc.) e da sua situação socioeconómica. A Instituição entende
        o utente como o elemento central e mais importante, acreditando que
        contribuir para o seu bem-estar, colmatando as suas necessidades, é
      ...
      <li>
        ...
        responsabilidade pública e que a intervenção social local e as suas
        atividades e respostas sociais têm um grande impacto na comunidade. No
        entanto, para prestar apoio social à freguesia de Casal Comba, qualquer
        iniciativa somente poderá ser realizada com o estabelecimento de
        parcerias com as entidades locais e com a colaboração de todos os que
        residem na sua área de atuação.
      </li>
    </ul>
  ),
  id: 1,
